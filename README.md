...
### 1. 🖥️ GUI Лончер (start-gui.ps1) - Новое!
...
- **Управление Foundry**: Запуск и мониторинг через веб-интерфейс

### 2. 🐳 Docker Compose (start-docker.ps1) - Обновлено!
- **Изолированная среда** выполнения
- **Автоматическая сборка** и развертывание
- **Volume mapping** для логов и данных
- **Health checks** и автоперезапуск
- **PowerShell скрипт** с цветным выводом
